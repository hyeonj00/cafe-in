...
<div id="content" class="content">
    ...
    if ($upload_success) {
        ...
        $stmt->execute();
       echo "<span style='font-size: larger; font-weight: bold;'> 이벤트 업로드를 완료하였습니다. </span>";
    } else {
        echo  "<span style='font-size: larger; font-weight: bold;'>죄송합니다.<br> 이벤트 이미지를 업로드하는 중에 오류가 발생했습니다.</span>";
    }
