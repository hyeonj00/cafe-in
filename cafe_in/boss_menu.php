		...
		<div id="m_content" class="m_content">
			...
			<div class="profile_div">
				...
				<ul>
					...
					<li><a href="boss_stamp_edit.php"><img src="img/img_business3.png" alt=""><br>스탬프 관리</a></li>
					<li><a href="boss_coupon_edit.php"><img src="img/img_business4.png" alt=""><br>쿠폰 관리</a></li>
