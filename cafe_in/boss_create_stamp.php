	...
	<div class="wrap">
		...
		<div id="m_content" class="m_content">
			...
			<div class="profile_div">
				<form action="boss_upload_stamp.php" method="post" enctype="multipart/form-data">
					<h2 style="font-size: larger; border-bottom: none;">&nbsp;&nbsp;&nbsp;&nbsp;스탬프 이미지를 선택해주세요.</h2>
					<input type="file" name="image1" id="image1"><br><br>
					<h2 style="font-size: larger; border-bottom: none;">&nbsp;&nbsp;&nbsp;&nbsp;스탬프북 이미지를 선택해주세요</h2>
